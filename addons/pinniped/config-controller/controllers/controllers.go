...
// +kubebuilder:rbac:resources=configmaps,verbs=list;watch;get
// +kubebuilder:rbac:resources=secrets,verbs=list;watch;get;patch;update;delete
// +kubebuilder:rbac:resources=clusters,verbs=list;watch;get
